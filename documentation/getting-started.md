...
## Start Exploring
### Import a File
To begin, import a file into Procellar. Currently, Procellar supports importing an OCEL(in OCEL 2.0 format and JSON format only) and a definition file that generated by Procellar. Please ensure your file conforms to this standard.
...
- The process list will also appear, though it will be empty initially if the OCEL you imported has not been enriched by process scopes or you didn't import a definition file.
