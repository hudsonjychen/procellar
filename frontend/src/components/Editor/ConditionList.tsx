    ...
    return (
        ...
        >
                ...
                onChange={(_, newValue) => {
                    ...
                    setSelectedConditions((prev) => ({
                        ...
                        action: prev[action].map((item) =>
                            item.id === id
                                ? { ...item, type: type, entity: newValue }
                                : item
                        ),
                    }))
                }}
            >
                {action === 'include'
                    ? [
                          ...selectedEntities.includeOT,
                          ...selectedEntities.includeAct,
                      ].map((item) => (
                    ...
                    : [
                          ...selectedEntities.excludeOT,
                          ...selectedEntities.excludeAct,
                      ].map((item) => (
                          <Option key={item} value={item}>
                              {item}
                          </Option>
